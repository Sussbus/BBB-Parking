			...
			<div id="page-wrapper">
				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							<h2>Swift Park</h2>
							<p>SWIFT PARK MATCHES BUYERS AND SELLERS<br>
								OF PARKING SPACES NEAR NEW TRIER HIGH SCHOOL.<br>
								IF YOU ARE INTERESTED IN LEASING A PARKING SPOT,<br>
								PLEASE VISIT THE “SPOT MAP” PAGE TO GET STARTED.<br>
							</p>
							<ul class="actions">
								<?php
								if($_SESSION['email']) {
									echo '<li><a href="map.php" class="button special">Spot Map</a></li>';
								} else {
				...
				<!-- Footer -->
					<footer id="footer">
						<ul class="icons">
							...
							<li><a href="mailto:park@bitbybite.co?Subject=Hello" class="icon fa-envelope-o"><span class="label">Email</span></a></li>
						</ul>
						<ul class="copyright">
